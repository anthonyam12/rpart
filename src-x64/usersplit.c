	       ...
	       double *parm, int *size, int who, double *wt)
{
    if (who == 1) 
    {
      	 ...
      	 */
      	/** 
      	 * Typically, a user would write this function in R and a callback would be set up.
      	 * In our case, we're using C to do our logic so this callback is removed and 
      	 * our own code is inserted below it.
      	 **/
